...
app.use(serveStatic(__dirname.slice(0, -4) + '/built/bin', {'index': ['default.html', 'default.htm']}));
app.use(serveStatic(__dirname.slice(0, -4) + '/public', {'index': ['default.html', 'default.htm']}));
app.listen(8080);
// 
